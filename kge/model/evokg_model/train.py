...
def main(args):
    ...
    embedding_updater = EmbeddingUpdater(G.number_of_nodes(),
                                         ...
                                         args.embedding_updater_structural_gconv,  # 没有
    ...
    if args.static_dynamic_combine_mode == "static_only":  # non
    ...
    try:
        for epoch in range(args.epochs):
            ...
            dynamic_entity_emb = init_dynamic_entity_embeds  # 这是 t_i^{*, t-1} 上一时间的特征
